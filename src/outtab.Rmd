...
cvd1y <- survfunc(
  ...
  timevar = "sos_outtime_death_1y",
  val = "CV",
  eventname = "CV Death 1 year follow-up",
  compevent = "sos_deathcause_catcv_cr_1y"
)
cvd5y <- survfunc(
...
noncvd1y <- survfunc(
  ...
  timevar = "sos_outtime_death_1y",
  val = "Non-CV",
  eventname = "Non-CV Death 1 year follow-up",
  compevent = "sos_deathcause_catnoncv_cr_1y"
)
