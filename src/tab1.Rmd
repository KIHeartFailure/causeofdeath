...
tab1 <- tab1 %>%
  mutate(
    footnote1 = if_else(str_detect(var_tmp, "^scb_dispincome_cat"), footnote_marker_symbol(1), ""),
    footnote2 = if_else(str_detect(var_tmp, "^shf_ntprobnp_cat"), footnote_marker_symbol(2), "")
  ) %>%
